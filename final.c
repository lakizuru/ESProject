...
// variables to store previous pointing direction
char l1; //for single sensor triggered
char l2; //for double sensor triggered
...
int main () {
	...
	//CTC mode, internal clk, prescaler = 8x
	TCCR1A = 0x00; 
	TCCR1B = 0x0A;
